...
- `ShowTimer`: Toggle the Bar Close Timer display (default: true).
- `TimerColor`, `TimerFontSize`: Customize the timer's appearance.
- `TimerX`, `TimerY`: Adjust the timer display position.
